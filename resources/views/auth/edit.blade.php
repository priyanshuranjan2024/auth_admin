                ...
                <div class="bg-white shadow-md rounded-lg p-6 max-w-sm mx-auto">
                    ...
                    <form action="{{ route('update_data', $data->id) }}" method="POST" class="max-w-lg mx-auto"
                        ...
                        <div class="mb-4">
                            ...
                            <img id="blah" alt="your image" width="100" height="100" class="hidden" />
                            <input type="file" name="image" id="image"
                                class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
                                onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0]);document.getElementById('blah').classList.remove('hidden')">
